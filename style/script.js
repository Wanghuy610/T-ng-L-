window.addEventListener("load", () => {
  const messages = [
    "Chúc bạn Hà luôn khỏe mạnh và hạnh phúc 🌸",
    "Cảm ơn bạn rất nhiều vì đã là bạn của tui 💖",
    "Chúc nữa nè là luôn luôn giữ nụ cười hiền và ánh mắt dịu dàng, như ngọn đèn sưởi ấm gia đình 💕",
    "Thankiu so much 🌷",
    "Học tiếng trung học đâu nhớ đấy nha 🌼",
    "Sau này giàu về nuôi b 💫",
  ];
